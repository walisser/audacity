...
class ODDecodeTask /* not final */ : public ODTask
{
 public:
   ...
   QString GetTaskName() override { return "ODDecodeTask"; }

   QString GetTip() override { return _("Decoding Waveform"); }

   ///Subclasses should override to return respective type.
   unsigned int GetODType() override { return eODNone; }

   ///Creates an ODFileDecoder that decodes a file of filetype the subclass handles.
   virtual ODFileDecoder* CreateFileDecoder(const QString& fileName)=0;
...
public:
   ...
   ODFileDecoder(const QString& fName);
   ...
   const QString &GetFileName(){return mFName;}
