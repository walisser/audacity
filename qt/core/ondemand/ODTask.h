...
/// will do the smallest unit of work possible
   ...
   virtual bool CanMergeWith(ODTask* otherTask){return GetTaskName() == otherTask->GetTaskName();}
   ...
   virtual QString GetTaskName(){return "ODTask";}
