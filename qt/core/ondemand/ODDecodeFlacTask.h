...
class ODDecodeFlacTask final : public ODDecodeTask
{
 public:
   ...
   ODFileDecoder* CreateFileDecoder(const QString & fileName) override;
...
public:
   ...
   ODFlacDecoder(const QString & fileName);
...
//   QMutex                mFlacFileLock;//for mFile;
   //wxFFile               mHandle;
...
//   //WaveTrack           **mChannels;
   ...
   size_t                mDecodeBufferWritePosition;
   size_t                mDecodeBufferLen;
